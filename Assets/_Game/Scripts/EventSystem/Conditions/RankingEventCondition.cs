...
{
    /// <summary>
    /// [기능]: 랭킹 이벤트을 이벤트 완료 조건으로 달성하였는지 판정하는 Strategy 클래스.
    /// [작성자]: 윤승종
    /// </summary>
    ...
    public class RankingEventCondition : BaseEventCondition
    {
        ...
        /// [수정 내용]: 최초 작성
        /// </summary>
        public RankingEventCondition(int targetValue, ISaveSystem saveSystem, ITimeProvider timeProvider, string eventId)
